import { cn } from "/codecafe/codecafe.cloud/codecafe/src/utils/cn";
        ...
        >
          ...
          <Card className="">
            <img
              src={item.image}
              alt={item.title}
              className="rounded-lg shadow-md w-[100%] object-cover"
            />
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-black text-center font-bold tracking-wide mt-4", className)}>
      {children}
    </h4>
  );
};
